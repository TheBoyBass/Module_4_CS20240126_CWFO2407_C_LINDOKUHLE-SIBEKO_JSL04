...
if (userPreference=='Sugar-free'){
    console.log(`This User prefers the Sugar-free variety`);
}else if (userPreference=='' || userPreference=='Regualar'){
    console.log('This user prefers the Regular variety')
}else{
    console.log('This user prefers an unknown variety')
}
