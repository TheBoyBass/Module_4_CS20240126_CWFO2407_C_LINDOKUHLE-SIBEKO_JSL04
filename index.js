...
let UserFlavour = userPreference == 'Sugar-free' ? `This User prefers the Sugar-free variety` : (userPreference == '' || userPreference == 'Regular' ? 'This user prefers the Regular variety' : 'This user prefers an unknown variety');
...
UserHeartRate = heartRate < 100 ? "Boost needed!" : `Energy Levels are high!`;
...
let Output = currentTemp <= 5 ? "Chilled to perfection!" : "Needs a cooler!";
console.log(Output)
